...
public class SubStudentsListAdapter extends BaseAdapter {
    Context context;
    private List<StudentListResponse> dataList;
    LayoutInflater layoutInflater;

    public SubStudentsListAdapter(Context context, List<StudentListResponse> dataList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = layoutInflater.inflate(R.layout.class_student_list, null);
        }
        TextView studentId = (TextView) convertView.findViewById(R.id.stuid);
        TextView studentName = (TextView) convertView.findViewById(R.id.stuname);
        ShapeableImageView studentImage = (ShapeableImageView) convertView.findViewById(R.id.stuimage);
